api_id = 21671564 # Ваш апи айди
api_hash='b3522864159dbfe8c630c4b1a2ace547' # Ваш апи ключ

channel = -1002279794074 # Айди канала с логами об активированных чеках. Если вы хотите указать публичный канал, то введите 'тег без @', Например channel = 'lovec_checkov'
...
avto_vivod_tag = 'Harib0dev' # Тег аккаунта(без @), куда раз в сутки будет отправляться чек со всеми собранными средствами. Например avto_vivod_tag = 'absolutely_enough'
...
ocr_api_key = 'K84968381088957' # Инструкция по получению: https://telegra.ph/Poluchenie-OCR-API-KEY-11-03
